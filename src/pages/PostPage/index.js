...
function SearchPage() {
    ...
    const checkInputFillComplete = () => {
        if (handleCheck()) {
            ...
            alert(
                'You must fill in the information about Name hotel, Address, Phone Number, Star, Description, Thumbnail, Slider',
            );
        }
    };
                ...
                <form className="App" autoComplete="off">
                    <div className="form-field">
                        ...
                        <input
                            ...
                            id="utilities"
                            value={nameUtility}
                            onChange={(e) => setNameUtility(e.target.value)}
                        />
                        <br></br>
                        <br></br>
                        <input
                            ...
                            type="text"
                            id="utilities-img"
                            value={imgNameUtility}
                            onChange={(e) => setImgNameUtility(e.target.value)}
                        />
                        ...
                        <button
                            type="button"
                            onClick={handleUtilitiesAdd}
                            className="bt btn btn-success add-btn-utilitie"
                        >
            ...
            <div className="container">
                                ...
                                <div className="post-wrap w-100 p-lg-5 p-4 rounded-5">
                                    ...
                                    <Form>
                                        ...
                                        <Form.Group className="post-group mb-3">
                                            ...
                                            <br></br>
                                            <br></br>
                                            {thumbnail && <div className="result">{renderPhoto(thumbnail)}</div>}
                                        </Form.Group>
                                    </Form>
                                </div>
                            </div>
                ...
                <Form.Group className="post-group mb-3">
                    <div className="text-center">
                        <button type="button" className="mbt btn btn-primary" onClick={checkInputFillComplete}>
                            Submit
                        </button>
                    </div>
                </Form.Group>
