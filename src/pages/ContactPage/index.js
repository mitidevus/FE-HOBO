                            ...
                            <div className="row no-gutters">
                                <div className="col-md-6">
                                    <div className="contact-wrap w-100 p-lg-5 p-4 rounded-5">
                                        <h3 className="h3-title mb-4">Send us a message</h3>
                                    ...
                                    <div className="info-wrap w-100 p-lg-5 p-4 img">
                                        ...
                                        <div className="dbox w-100 d-flex align-items-start">
                                            ...
                                            <div className="text pl-3">
                                                <p>
                                                    <span>Address:</span> 227 Nguyen Van Cu Street, Ward 4, District 5,
                                        ...
                                        <div className="dbox w-100 d-flex align-items-center">
                                            ...
                                            <div className="text pl-3">
                                                <p>
                                                    <span>Phone: </span>
                                                    <a className="linkURL" href="tel://123456789">
                                                        Undone
                                                    </a>
                                                </p>
                                            </div>
                                        ...
                                        <div className="dbox w-100 d-flex align-items-center">
                                            ...
                                            <div className="text pl-3">
                                                <p>
                                                    <span>Email: </span>
                                                    <a className="linkURL" href="mailto:hobovn.website@gmail.com">
